...
type Nav = NativeStackNavigationProp<HomeStackParamList, 'EFootballSetup'>;
type Rt = RouteProp<HomeStackParamList, 'EFootballSetup'>;

const HOUR_MS = 3_600_000;

export function EFootballSetupScreen() {
  ...
  return (
    <ScreenContainer testID="efootball-setup-screen">
      <View style={styles.header}>
        <TouchableOpacity
          onPress={() => navigation.goBack()}
          accessibilityRole="button"
          accessibilityLabel="Go back"
          testID="efootball-back-btn"
        >
      ...
      <ReadonlyChip
        ...
        value="✓ Yes"
        tone="success"
        testID="chip-penalties"
      />
      <ReadonlyChip
        label="Extra Time"
        value="✗ Off"
        tone="error"
        testID="chip-extra-time"
      />
